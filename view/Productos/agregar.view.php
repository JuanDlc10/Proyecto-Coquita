					...
					<div class="row g-0">
						<div class="col-md-12">
							<div class="card-body p-3 p-lg-4 text-black" style="background-color: black;">
								<h2 class="fw-normal mb-3 pb-3 text-center text-purple-700" style="letter-spacing: 1px;">Guardar Producto</h2>
								<form id="form" action="<?= $config->redireccion('guardarProducto') ?>" method="POST" enctype="multipart/form-data">
									<div class="row">
										<div class="col-6">
									...
									<div class="text-center">
										<button data-mdb-button-init data-mdb-ripple-init class="btn btn btn-outline-purple" type="button" onclick="validarProducto()">Guardar</button>
