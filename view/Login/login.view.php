					...
					<div class="row g-0">
						...
						<div class="col-md-6 col-lg-7 d-flex align-items-center" style="background-color: black;">
							<div class="card-body p-3 p-lg-4 text-black">
								...
								<form id="form" action="<?= $config->redireccion("validarLogin") ?>" method="POST">
									...
									<h5 class="fw-normal mb-3 pb-3 text-purple-300 text-center" style="letter-spacing: 1px;">Ingresar</h5>
									...
									<div class="pt-1 mb-4 d-flex justify-content-end">
										<button data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-dark btn-lg btn-block text-purple-300" type="button" onclick="validarLogin()">Login</button>
									</div>
									<p class=" mb-4 text-purple-300">No tienes cuenta? <a href="<?= $config->redireccion('sigin') ?>" class="text-purple-300 ">Registrar aqui</a></p>
								</form>
							</div>
						</div>
					</div>
