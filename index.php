...
<head>
    ...
    <link rel="stylesheet" href="<?= $config->depCss('bootstrap.min.css') ?>"></link>
    <link rel="stylesheet" href="<?= $config->depCss('style.css') ?>"></link>
    <link rel="stylesheet" href="<?= $config->depCss('sweetalert.min.css') ?>"></link>
    <script src="<?= $config->depController('coquita.controller.js') ?>"></script>
